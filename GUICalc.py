...
def press(num):
    #point out the global exprssion var
    global expression
...
def equalpress():
    #try and except state for errors like zero
    try:
...
if __name__ == "__main__":
    ...
    #set the configuration of the GUI winodw
    ...
    #positions in a table like structure
    expression_field.grid(columnspan=4, ipadx=70)

    equation.set('enter your expression')

    #create buttons and place a a particular location inside the root window
    #when the button is click, command function is executed
